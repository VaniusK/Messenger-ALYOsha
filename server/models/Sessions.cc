...
const std::string Sessions::Cols::_token_hash = "\"token_hash\"";
...
{"token_hash","std::string","character varying",255,0,0,1},
...
const std::string &Sessions::getValueOfTokenHash() const noexcept
{
...
const std::shared_ptr<std::string> &Sessions::getTokenHash() const noexcept
{
    return tokenHash_;
}
void Sessions::setTokenHash(const std::string &pTokenHash) noexcept
{
    tokenHash_ = std::make_shared<std::string>(pTokenHash);
    dirtyFlag_[2] = true;
}
void Sessions::setTokenHash(std::string &&pTokenHash) noexcept
{
