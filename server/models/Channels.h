...
class Channels
{
  public:
     ...
     */
    explicit Channels(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Channels(const Json::Value &pJson) noexcept(false);
     ...
     */
    Channels(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Channels>;
    friend drogon::orm::BaseBuilder<Channels, true, true>;
    friend drogon::orm::BaseBuilder<Channels, true, false>;
    friend drogon::orm::BaseBuilder<Channels, false, true>;
    friend drogon::orm::BaseBuilder<Channels, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Channels>;
#endif
