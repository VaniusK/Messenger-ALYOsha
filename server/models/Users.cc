...
const std::string Users::Cols::_handle = "\"handle\"";
...
Users::Users(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        if(!r["last_synced_message_id"].isNull())
        {
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            lastSyncedMessageId_=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
        index = offset + 6;
        if(!r[index].isNull())
        {
...
Users::Users(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[4].empty() && pJson.isMember(pMasqueradingVector[4]))
    {
        ...
        {
            avatarPath_=std::make_shared<std::string>(pJson[pMasqueradingVector[4]].asString());
        }
    }
    if(!pMasqueradingVector[5].empty() && pJson.isMember(pMasqueradingVector[5]))
    {
        ...
        {
            lastSyncedMessageId_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[5]].asInt64());
        }
    }
...
Users::Users(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("last_synced_message_id"))
    {
        dirtyFlag_[5]=true;
        if(!pJson["last_synced_message_id"].isNull())
        {
...
const std::string &Users::getValueOfHandle() const noexcept
{
...
const std::shared_ptr<std::string> &Users::getHandle() const noexcept
{
    return handle_;
}
void Users::setHandle(const std::string &pHandle) noexcept
{
    handle_ = std::make_shared<std::string>(pHandle);
    dirtyFlag_[1] = true;
}
void Users::setHandle(std::string &&pHandle) noexcept
{
...
const int64_t &Users::getValueOfLastSyncedMessageId() const noexcept
{
    static const int64_t defaultValue = int64_t();
    if(lastSyncedMessageId_)
        return *lastSyncedMessageId_;
    return defaultValue;
}
const std::shared_ptr<int64_t> &Users::getLastSyncedMessageId() const noexcept
{
    return lastSyncedMessageId_;
}
void Users::setLastSyncedMessageId(const int64_t &pLastSyncedMessageId) noexcept
{
    lastSyncedMessageId_ = std::make_shared<int64_t>(pLastSyncedMessageId);
    dirtyFlag_[5] = true;
}
void Users::setLastSyncedMessageIdToNull() noexcept
{
    lastSyncedMessageId_.reset();
    dirtyFlag_[5] = true;
}
...
const std::shared_ptr<std::string> &Users::getDescription() const noexcept
{
    return description_;
}
...
void Users::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    ...
    if(dirtyFlag_[5])
    {
        if(getLastSyncedMessageId())
        {
            binder << getValueOfLastSyncedMessageId();
        }
        else
        {
            binder << nullptr;
...
Json::Value Users::toJson() const
{
    ...
    if(getLastSyncedMessageId())
    {
        ret["last_synced_message_id"]=(Json::Int64)getValueOfLastSyncedMessageId();
    }
    else
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 9)
    {
        ...
        if(!pMasqueradingVector[4].empty())
        {
            if(getAvatarPath())
            {
                ret[pMasqueradingVector[4]]=getValueOfAvatarPath();
            }
            else
            {
        ...
        if(!pMasqueradingVector[5].empty())
        {
            if(getLastSyncedMessageId())
            {
                ret[pMasqueradingVector[5]]=(Json::Int64)getValueOfLastSyncedMessageId();
            }
            else
            {
...
bool Users::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("avatar_path"))
    {
        if(!validJsonOfField(4, "avatar_path", pJson["avatar_path"], err, true))
            return false;
    }
    if(pJson.isMember("last_synced_message_id"))
    {
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("avatar_path"))
    {
        if(!validJsonOfField(4, "avatar_path", pJson["avatar_path"], err, false))
            return false;
    }
    if(pJson.isMember("last_synced_message_id"))
    {
